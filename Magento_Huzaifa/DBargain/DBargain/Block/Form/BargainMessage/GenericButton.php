...
/**
 * Generic (form) button for BargainMessage entity.
 */
class GenericButton
{
    /**
    ...
    /**
     * Get BargainMessage entity id.
     *
     * @return int
     */
    public function getBargainMessageId(): int
    {
        return (int) $this->context->getRequest()->getParam(BargainMessageInterface::BARGAIN_MESSAGE_ID);
    }
