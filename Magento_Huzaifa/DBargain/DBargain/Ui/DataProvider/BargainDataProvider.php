...
use DBargain\DBargain\Query\Bargain\GetListQuery;
 ...
 */
class BargainDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int) $item[BargainInterface::BARGAIN_ID]] = $item;
        }

        if ($id = $this->request->getParam(BargainInterface::BARGAIN_ID)) {
