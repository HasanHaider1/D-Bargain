 ...
 */
class BargainReportBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'BargainReport';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH   = 'bargain_report/bargainreport/edit';
    private const DELETE_URL_PATH = 'bargain_report/bargainreport/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[BargainReportData::BARGAIN_REPORT_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData    = [BargainReportData::BARGAIN_REPORT_ID => $item[BargainReportData::BARGAIN_REPORT_ID]];
