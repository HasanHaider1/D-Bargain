...
namespace DBargain\DBargain\Ui\Component\Listing\Column;
 ...
 */
class BargainMessageBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'BargainMessage';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH   = 'bargain_message/bargainmessage/edit';
    private const DELETE_URL_PATH = 'bargain_message/bargainmessage/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[BargainMessageInterface::BARGAIN_MESSAGE_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData    = [BargainMessageInterface::BARGAIN_MESSAGE_ID => $item[BargainMessageInterface::BARGAIN_MESSAGE_ID]];
